...
wget -qO- $V2RAYCONFIG | sed -e "s/\$AUUID/$AUUID/g" -e "s/\$APASSWORD/$APASSWORD/g" -e "s/\$VMESSPATH/\\$VMESSPATH/" -e "s/\$VLESSPATH/\\$VLESSPATH/" -e "s/\$TROJANPATH/\\$TROJANPATH/" >/v2ray.json
